...
-- Database: `first`
--
CREATE DATABASE `first` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `first`;
...
(NULL, 'first', 'example', 'id', 1, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'first', 'example', 'data', 2, NULL, 'YES', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'event_registration', 'id', 1, NULL, 'NO', 'bigint', NULL, NULL, 19, 0, NULL, NULL, 'bigint(20)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'event_registration', 'event_id', 2, NULL, 'NO', 'bigint', NULL, NULL, 19, 0, NULL, NULL, 'bigint(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'event_registration', 'event_type', 3, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'event_registration', 'master_email', 4, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'event_registration', 'team_name', 5, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'event_registration', 'team_size', 6, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'event_registration', 'user_id_list', 7, NULL, 'YES', 'varchar', 1250, 1250, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(1250)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'event_registration', 'email_list', 8, NULL, 'YES', 'varchar', 1025, 1025, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(1025)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'event_registration', 'name_list', 9, NULL, 'YES', 'varchar', 1025, 1025, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(1025)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'event_registration', 'number_list', 10, NULL, 'YES', 'varchar', 1025, 1025, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(1025)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'event_registration', 'other_details', 11, NULL, 'YES', 'varchar', 1025, 1025, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(1025)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'event_registration', 'created', 12, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'event_registration', 'status', 13, NULL, 'YES', 'varchar', 1025, 1025, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(1025)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'events', 'id', 1, NULL, 'NO', 'bigint', NULL, NULL, 19, 0, NULL, NULL, 'bigint(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'events', 'mask', 2, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'events', 'name', 3, NULL, 'NO', 'varchar', 225, 225, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(225)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'events', 'type', 4, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'events', 'introduction', 5, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'events', 'guidelines', 6, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'events', 'rules', 7, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'events', 'faq', 8, NULL, 'YES', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'events', 'download', 9, NULL, 'YES', 'blob', 65535, 65535, NULL, NULL, NULL, NULL, 'blob', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'eventssystem', 'event_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'eventssystem', 'event_name', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_general_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'eventssystem', 'round_no', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'eventssystem', 'event_time', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'eventssystem', 'navigation_allowed', 5, '0', 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'eventssystem', 'no_of_questions', 6, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'eventssystem', 'contains_section', 7, '0', 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'eventssystem', 'is_published', 8, '0', 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'eventssystem', 'instructions', 9, NULL, 'NO', 'blob', 65535, 65535, NULL, NULL, NULL, NULL, 'blob', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'eventssystem', 'timestamp', 10, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'questions', 'q_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'questions', 'event_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'questions', 'q_type', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_general_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'questions', 'display_no', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'questions', 'ans_type', 5, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_general_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'questions', 'no_of_options', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'questions', 'has_image', 7, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'questions', 'is_mandatory', 8, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'questions', 'q_content', 9, NULL, 'NO', 'longtext', 4294967295, 4294967295, NULL, NULL, 'latin1', 'latin1_general_ci', 'longtext', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'questions', 'note', 10, NULL, 'NO', 'mediumtext', 16777215, 16777215, NULL, NULL, 'latin1', 'latin1_general_ci', 'mediumtext', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'questions', 'options', 11, NULL, 'NO', 'mediumtext', 16777215, 16777215, NULL, NULL, 'latin1', 'latin1_general_ci', 'mediumtext', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'questions', 'timestamp', 12, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'user_progress', 'status_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'user_progress', 'user_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'user_progress', 'event_id', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'user_progress', 'present_q', 4, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'user_progress', 'started', 5, '0', 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'user_progress', 'completed', 6, '0', 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'user_progress', 'time_remaining', 7, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'user_progress', 'timestamp', 8, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'user_response', 'response_id', 1, NULL, 'NO', 'bigint', NULL, NULL, 19, 0, NULL, NULL, 'bigint(20)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'user_response', 'user_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'user_response', 'event_id', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'user_response', 'q_id', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'user_response', 'response', 5, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_general_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'user_response', 'q_display_no', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'user_response', 'timestamp', 7, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'users', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'users', 'username', 2, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'users', 'password', 3, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'users', 'email', 4, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'users', 'mobile', 5, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'users', 'organization', 6, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'users', 'country', 7, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'users', 'level', 8, NULL, 'NO', 'bigint', NULL, NULL, 19, 0, NULL, NULL, 'bigint(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'users', 'verified', 9, NULL, 'YES', 'bigint', NULL, NULL, 19, 0, NULL, NULL, 'bigint(255)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'users', 'name', 10, 'intagpart', 'NO', 'varchar', 225, 225, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(225)', '', '', 'select,insert,update,references', ''),
(NULL, 'intagli2_wrd6', 'users', 'semail', 11, NULL, 'YES', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
...
(NULL, 'researchportal', 'budget', 'Date', 1, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'budget', 'ProjectId', 2, NULL, 'YES', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'budget', 'dataset', 3, NULL, 'YES', 'float', NULL, NULL, 10, 0, NULL, NULL, 'float(10,0)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'budget', 'communication', 4, NULL, 'YES', 'float', NULL, NULL, 10, 0, NULL, NULL, 'float(10,0)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'budget', 'field', 5, NULL, 'YES', 'float', NULL, NULL, 10, 0, NULL, NULL, 'float(10,0)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'budget', 'photocopying', 6, NULL, 'YES', 'float', NULL, NULL, 10, 0, NULL, NULL, 'float(10,0)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'budget', 'stationery', 7, NULL, 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'budget', 'domestictravel', 8, NULL, 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'budget', 'localconveyance', 9, NULL, 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'budget', 'accomodation', 10, NULL, 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'budget', 'contingency', 11, NULL, 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'budget', 'software', 12, NULL, 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'budget', 'dessimination', 13, NULL, 'YES', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'budget', 'recurring', 14, '0', 'NO', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'c_budget', 'date', 1, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'c_budget', 'ConferenceId', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'c_budget', 'registrationCharges', 3, '0', 'NO', 'decimal', NULL, NULL, 50, 0, NULL, NULL, 'decimal(50,0)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'c_budget', 'travel', 4, '0', 'NO', 'decimal', NULL, NULL, 50, 0, NULL, NULL, 'decimal(50,0)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'c_budget', 'stay', 5, '0', 'NO', 'decimal', NULL, NULL, 50, 0, NULL, NULL, 'decimal(50,0)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'c_budget', 'perDiem', 6, '0', 'NO', 'decimal', NULL, NULL, 50, 0, NULL, NULL, 'decimal(50,0)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'comment', 'Project_ID', 1, NULL, 'NO', 'bigint', NULL, NULL, 19, 0, NULL, NULL, 'bigint(200)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'comment', 'Comment', 2, NULL, 'NO', 'varchar', 5000, 5000, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(5000)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'comment', 'Comment_type', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'comment', 'User', 4, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'comment', 'User_type', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'comment', 'Date', 6, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'conference', 'ConferenceTitle', 1, NULL, 'NO', 'varchar', 400, 400, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(400)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'conference', 'ConferenceId', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(200)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'conference', 'Description', 3, NULL, 'NO', 'varchar', 2000, 2000, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(2000)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'conference', 'App_Date', 4, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'conference', 'Start_Date', 5, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'conference', 'End_Date', 6, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'conference', 'Researcher1', 7, NULL, 'NO', 'varchar', 80, 80, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'conference', 'ConferenceCategory', 8, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'conference', 'ConferenceGrant', 9, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'conference', 'CStatus', 10, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'conference', 'Block_number', 11, '0', 'NO', 'bigint', NULL, NULL, 19, 0, NULL, NULL, 'bigint(100)', '', '', 'select,insert,update,references', 'first block 1st jan 2001- each block of 3 years; 0 for student'),
(NULL, 'researchportal', 'conferencecompleted', 'ConferenceId', 1, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'conferenceextension', 'ConferenceId', 1, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'conferenceextension', 'Period', 2, NULL, 'NO', 'bigint', NULL, NULL, 19, 0, NULL, NULL, 'bigint(200)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'project', 'ProjectTitle', 1, NULL, 'NO', 'varchar', 400, 400, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(400)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'project', 'ProjectId', 2, NULL, 'NO', 'bigint', NULL, NULL, 19, 0, NULL, NULL, 'bigint(200)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'project', 'Description', 3, NULL, 'NO', 'varchar', 2000, 2000, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(2000)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'project', 'App_Date', 4, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', 'The  date of application of the project'),
(NULL, 'researchportal', 'project', 'Start_Date', 5, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'project', 'End_Date', 6, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'project', 'Researcher1', 7, NULL, 'NO', 'varchar', 80, 80, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'project', 'Researcher2', 8, NULL, 'NO', 'varchar', 80, 80, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'project', 'Researcher3', 9, NULL, 'NO', 'varchar', 80, 80, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'project', 'ProjectCategory', 10, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'project', 'ProjectGrant', 11, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'project', 'PStatus', 12, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'project', 'Deliverables', 13, NULL, 'NO', 'varchar', 500, 500, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(500)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'project', 'cases', 14, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'project', 'journals', 15, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'project', 'chapters', 16, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'project', 'conference', 17, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'project', 'paper', 18, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'projectcompleted', 'ProjectId', 1, NULL, 'NO', 'bigint', NULL, NULL, 19, 0, NULL, NULL, 'bigint(200)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'projectextension', 'ProjectId', 1, NULL, 'NO', 'bigint', NULL, NULL, 19, 0, NULL, NULL, 'bigint(200)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'projectextension', 'Period', 2, NULL, 'NO', 'bigint', NULL, NULL, 19, 0, NULL, NULL, 'bigint(200)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'projectextension', 'ApprovalPending', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'recurring', 'ProjectId', 1, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'recurring', 'recurring_amt', 2, NULL, 'NO', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'recurring', 'total', 3, NULL, 'NO', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'users', 'Username', 1, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'users', 'role', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'users', 'password', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'researchportal', 'users', 'user_type', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', '');
...
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '0'),
('HANDLER_READ_FIRST', '57'),
('HANDLER_READ_KEY', '96'),
('HANDLER_READ_NEXT', '120'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '2484'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '4'),
('HANDLER_WRITE', '1836'),
('INNODB_BUFFER_POOL_PAGES_DATA', '71'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '66'),
('INNODB_BUFFER_POOL_PAGES_FREE', '6584'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '6656'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '1'),
('INNODB_BUFFER_POOL_READ_AHEAD_SEQ', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '9263'),
('INNODB_BUFFER_POOL_READS', '19'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '1403'),
('INNODB_DATA_FSYNCS', '63'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '3723264'),
('INNODB_DATA_READS', '104'),
('INNODB_DATA_WRITES', '119'),
('INNODB_DATA_WRITTEN', '2249728'),
('INNODB_DBLWR_PAGES_WRITTEN', '66'),
('INNODB_DBLWR_WRITES', '8'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '138'),
('INNODB_LOG_WRITES', '36'),
('INNODB_OS_LOG_FSYNCS', '45'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '82432'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '1'),
('INNODB_PAGES_READ', '70'),
('INNODB_PAGES_WRITTEN', '66'),
...
('INNODB_ROWS_READ', '728'),
('INNODB_ROWS_UPDATED', '4'),
('KEY_BLOCKS_NOT_FLUSHED', '0'),
('KEY_BLOCKS_UNUSED', '48346'),
('KEY_BLOCKS_USED', '0'),
('KEY_READ_REQUESTS', '0'),
('KEY_READS', '0'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '115875'),
('UPTIME_SINCE_FLUSH_STATUS', '115875');
...
('LANGUAGE', 'C:\\Program Files (x86)\\MySQL\\MySQL Server 5.1\\share\\english\\'),
...
('LOG_ERROR', 'C:\\ProgramData\\MySQL\\MySQL Server 5.1\\Data\\Nikhil-PC.err'),
...
('RAND_SEED1', ''),
('SLOW_QUERY_LOG_FILE', 'C:\\ProgramData\\MySQL\\MySQL Server 5.1\\Data\\Nikhil-PC-slow.log'),
...
('THREAD_STACK', '196608'),
('GENERAL_LOG_FILE', 'C:\\ProgramData\\MySQL\\MySQL Server 5.1\\Data\\Nikhil-PC.log'),
...
('PID_FILE', 'C:\\ProgramData\\MySQL\\MySQL Server 5.1\\Data\\Nikhil-PC.pid'),
('EXPIRE_LOGS_DAYS', '0'),
('NAMED_PIPE', 'OFF'),
...
('INNODB_BUFFER_POOL_SIZE', '109051904'),
...
(NULL, 'intagli2_wrd6', 'PRIMARY', NULL, 'intagli2_wrd6', 'event_registration', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'intagli2_wrd6', 'PRIMARY', NULL, 'intagli2_wrd6', 'eventssystem', 'event_id', 1, NULL, NULL, NULL, NULL),
(NULL, 'intagli2_wrd6', 'PRIMARY', NULL, 'intagli2_wrd6', 'questions', 'q_id', 1, NULL, NULL, NULL, NULL),
(NULL, 'intagli2_wrd6', 'PRIMARY', NULL, 'intagli2_wrd6', 'user_progress', 'status_id', 1, NULL, NULL, NULL, NULL),
(NULL, 'intagli2_wrd6', 'PRIMARY', NULL, 'intagli2_wrd6', 'user_response', 'response_id', 1, NULL, NULL, NULL, NULL),
(NULL, 'intagli2_wrd6', 'PRIMARY', NULL, 'intagli2_wrd6', 'users', 'id', 1, NULL, NULL, NULL, NULL),
 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'intagli2_wrd6', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'mysql', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'researchportal', 'latin1', 'latin1_swedish_ci', NULL),
...
('''intagli2_wrd6''@''localhost''', NULL, 'intagli2_wrd6', 'SELECT', 'NO'),
('''intagli2_wrd6''@''localhost''', NULL, 'intagli2_wrd6', 'INSERT', 'NO'),
('''intagli2_wrd6''@''localhost''', NULL, 'intagli2_wrd6', 'UPDATE', 'NO'),
('''intagli2_wrd6''@''localhost''', NULL, 'intagli2_wrd6', 'DELETE', 'NO'),
('''intagli2_wrd6''@''localhost''', NULL, 'intagli2_wrd6', 'CREATE', 'NO'),
('''intagli2_wrd6''@''localhost''', NULL, 'intagli2_wrd6', 'DROP', 'NO'),
('''intagli2_wrd6''@''localhost''', NULL, 'intagli2_wrd6', 'REFERENCES', 'NO'),
('''intagli2_wrd6''@''localhost''', NULL, 'intagli2_wrd6', 'INDEX', 'NO'),
('''intagli2_wrd6''@''localhost''', NULL, 'intagli2_wrd6', 'ALTER', 'NO'),
('''intagli2_wrd6''@''localhost''', NULL, 'intagli2_wrd6', 'CREATE TEMPORARY TABLES', 'NO'),
('''intagli2_wrd6''@''localhost''', NULL, 'intagli2_wrd6', 'LOCK TABLES', 'NO'),
('''intagli2_wrd6''@''localhost''', NULL, 'intagli2_wrd6', 'EXECUTE', 'NO'),
('''intagli2_wrd6''@''localhost''', NULL, 'intagli2_wrd6', 'CREATE VIEW', 'NO'),
('''intagli2_wrd6''@''localhost''', NULL, 'intagli2_wrd6', 'SHOW VIEW', 'NO'),
('''intagli2_wrd6''@''localhost''', NULL, 'intagli2_wrd6', 'CREATE ROUTINE', 'NO'),
('''intagli2_wrd6''@''localhost''', NULL, 'intagli2_wrd6', 'ALTER ROUTINE', 'NO'),
('''intagli2_wrd6''@''localhost''', NULL, 'intagli2_wrd6', 'EVENT', 'NO'),
('''intagli2_wrd6''@''localhost''', NULL, 'intagli2_wrd6', 'TRIGGER', 'NO'),
('''''@''%''', NULL, 'test', 'SELECT', 'NO'),
('''''@''%''', NULL, 'test', 'INSERT', 'NO'),
('''''@''%''', NULL, 'test', 'UPDATE', 'NO'),
('''''@''%''', NULL, 'test', 'DELETE', 'NO'),
...
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '66'),
('INNODB_BUFFER_POOL_PAGES_FREE', '6527'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '6656'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '2'),
('INNODB_BUFFER_POOL_READ_AHEAD_SEQ', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '11493'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '115876'),
('UPTIME_SINCE_FLUSH_STATUS', '115876');
...
(NULL, 'intagli2_wrd6', 'event_registration', 0, 'intagli2_wrd6', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', ''),
(NULL, 'intagli2_wrd6', 'eventssystem', 0, 'intagli2_wrd6', 'PRIMARY', 1, 'event_id', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'intagli2_wrd6', 'questions', 0, 'intagli2_wrd6', 'PRIMARY', 1, 'q_id', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 'intagli2_wrd6', 'questions', 1, 'intagli2_wrd6', 'event_id', 1, 'event_id', 'A', 1, NULL, NULL, '', 'BTREE', ''),
(NULL, 
(NULL, 'intagli2_wrd6', 'PRIMARY', 'intagli2_wrd6', 'eventssystem', 'PRIMARY KEY'),
(NULL, 'intagli2_wrd6', 'PRIMARY', 'intagli2_wrd6', 'questions', 'PRIMARY KEY'),
(NULL, 'intagli2_wrd6', 'PRIMARY', 'intagli2_wrd6', 'user_progress', 'PRIMARY KEY'),
(NULL, 'intagli2_wrd6', 'PRIMARY', 'intagli2_wrd6', 'user_response', 'PRIMARY KEY'),
(NULL, 'intagli2_wrd6', 'PRIMARY', 'intagli2_wrd6', 'users', 'PRIMARY KEY'),
...
(NULL, 'researchportal', 'PRIMARY', 'researchportal', 'conference', 'PRIMARY KEY'),
(NULL, 'researchportal', 'ProjectId', 'researchportal', 'conference', 'UNIQUE'),
(NULL, 'researchportal', 'ProjectId_2', 'researchportal', 'conference', 'UNIQUE'),
(NULL, 'researchportal', 'PRIMARY', 'researchportal', 'project', 'PRIMARY KEY'),
(NULL, 'researchportal', 'ProjectId', 'researchportal', 'project', 'UNIQUE'),
(NULL, 'researchportal', 'ProjectId_2', 'researchportal', 'project', 'UNIQUE'),
(NULL, 'researchportal', 'PRIMARY', 'researchportal', 'recurring', 'PRIMARY KEY');
...
('''intagli2_wrd6''@''localhost''', NULL, 'USAGE', 'NO'),
('''''@''localhost''', NULL, 'SELECT', 'YES'),
('''''@''localhost''', NULL, 'INSERT', 'YES'),
('''''@''localhost''', NULL, 'UPDATE', 'YES'),
('''''@''localhost''', NULL, 'DELETE', 'YES'),
('''''@''localhost''', NULL, 'CREATE', 'YES'),
('''''@''localhost''', NULL, 'DROP', 'YES'),
('''''@''localhost''', NULL, 'RELOAD', 'YES'),
('''''@''localhost''', NULL, 'SHUTDOWN', 'YES'),
('''''@''localhost''', NULL, 'PROCESS', 'YES'),
('''''@''localhost''', NULL, 'FILE', 'YES'),
('''''@''localhost''', NULL, 'REFERENCES', 'YES'),
('''''@''localhost''', NULL, 'INDEX', 'YES'),
('''''@''localhost''', NULL, 'ALTER', 'YES'),
('''''@''localhost''', NULL, 'SHOW DATABASES', 'YES'),
('''''@''localhost''', NULL, 'SUPER', 'YES'),
('''''@''localhost''', NULL, 'CREATE TEMPORARY TABLES', 'YES'),
('''''@''localhost''', NULL, 'LOCK TABLES', 'YES'),
('''''@''localhost''', NULL, 'EXECUTE', 'YES'),
('''''@''localhost''', NULL, 'REPLICATION SLAVE', 'YES'),
('''''@''localhost''', NULL, 'REPLICATION CLIENT', 'YES'),
('''''@''localhost''', NULL, 'CREATE VIEW', 'YES'),
('''''@''localhost''', NULL, 'SHOW VIEW', 'YES'),
('''''@''localhost''', NULL, 'CREATE ROUTINE', 'YES'),
('''''@''localhost''', NULL, 'ALTER ROUTINE', 'YES'),
('''''@''localhost''', NULL, 'CREATE USER', 'YES'),
('''''@''localhost''', NULL, 'EVENT', 'YES'),
('''''@''localhost''', NULL, 'TRIGGER', 'YES');
...
--
-- Database: `intagli2_wrd6`
--
CREATE DATABASE `intagli2_wrd6` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `intagli2_wrd6`;
...
CREATE TABLE IF NOT EXISTS `event_registration` (
  ...
  `user_id_list` varchar(1250) DEFAULT NULL,
  `email_list` varchar(1025) DEFAULT NULL,
  `name_list` varchar(1025) DEFAULT NULL,
  `number_list` varchar(1025) DEFAULT NULL,
  `other_details` varchar(1025) DEFAULT NULL,
  `created` varchar(255) DEFAULT NULL,
  `status` varchar(1025) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `events` (
  ...
  `guidelines` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `eventssystem`
--

CREATE TABLE IF NOT EXISTS `eventssystem` (
  `event_id` int(11) NOT NULL AUTO_INCREMENT,
  `event_name` text COLLATE latin1_general_ci NOT NULL,
  `round_no` int(11) NOT NULL,
  `event_time` int(11) NOT NULL,
  `navigation_allowed` tinyint(1) NOT NULL DEFAULT '0',
  `no_of_questions` int(11) NOT NULL DEFAULT '0',
  `contains_section` tinyint(1) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `eventssystem`
--

INSERT INTO `eventssystem` (`event_id`, `event_name`, `round_no`, `event_time`, `navigation_allowed`, `no_of_questions`, `contains_section`, `is_published`, `instructions`, `timestamp`) VALUES
(1, 'Test 1', 1, 30, 1, 1, 0, 1, 0x546573742065656e742031, '2012-11-18 18:55:32');
...
CREATE TABLE IF NOT EXISTS `questions` (
  ...
  `q_type` text COLLATE latin1_general_ci NOT NULL,
  `display_no` int(11) NOT NULL,
  `ans_type` text COLLATE latin1_general_ci NOT NULL,
  `no_of_options` int(11) NOT NULL,
  `has_image` tinyint(1) NOT NULL,
  `is_mandatory` tinyint(1) NOT NULL,
  `q_content` longtext COLLATE latin1_general_ci NOT NULL,
  `note` mediumtext COLLATE latin1_general_ci NOT NULL,
  `options` mediumtext COLLATE latin1_general_ci NOT NULL,
  `timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`q_id`),
...
INSERT INTO `questions` (`q_id`, `event_id`, `q_type`, `display_no`, `ans_type`, `no_of_options`, `has_image`, `is_mandatory`, `q_content`, `note`, `options`, `timestamp`) VALUES
(1, 1, 'MULTILINE', 1, 'MULTIPLE CHOICE - SINGLE ANSWER', 4, 1, 0, 'SASASASASASASA', '', 'OptionA |,| OptionB |,| OptionC |,| Option D\r\n               ', '2012-11-18 18:59:06');
...
CREATE TABLE IF NOT EXISTS `user_progress` (
  ...
  `event_id` int(11) NOT NULL,
  `present_q` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `user_progress` (`status_id`, `user_id`, `event_id`, `present_q`, `started`, `completed`, `time_remaining`, `timestamp`) VALUES
(1, 6, 1, 1, 1, 0, 28, '2012-11-18 19:01:39');
...
CREATE TABLE IF NOT EXISTS `user_response` (
  ...
  `q_display_no` int(11) NOT NULL,
  `timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`response_id`),
  KEY `user_id` (`user_id`),
  KEY `event_id` (`event_id`,`q_id`)
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `verified` bigint(255) DEFAULT NULL,
  `name` varchar(225) NOT NULL DEFAULT 'intagpart',
...
INSERT INTO `users` (`id`, `username`, `password`, `email`, `mobile`, `organization`, `country`, `level`, `verified`, `name`, `semail`) VALUES
(6, 'nikhil', 'a0128e4ae07c0ce7710460fb6e00be8b00f01984', 'nikhil.labh@gmail.com', '9674456585', 'IIMC', 'India', 1, 1, 'Nikhil', '');
--
-- Database: `mysql`
--
...
('localhost', 'intagli2_wrd6', 'intagli2_wrd6', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y');
...
('localhost', '', '', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0),
('localhost', 'intagli2_wrd6', '*BBF7CFE1A7D3BF5E4BA108C008BAB473D4D1F301', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', '', '', 0, 0, 0, 0);
--
-- Database: `researchportal`
--
CREATE DATABASE `researchportal` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `researchportal`;
