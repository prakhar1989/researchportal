...
<ul id="VerColMenu">
	<li><a title="Click to open or close this section" href="#">Conferences</a>
		<ul>
		    <li><a title="Click to open or close this section" href="http://localhost/ci/index.php/studentConfApp">Apply for Conference</a> </li>
			<li><a title="Click to open or close this section" href="http://localhost/ci/index.php/studentCongoing">Ongoing Conferences</a> </li>
			<li><a title="Click to open or close this section" href="http://localhost/ci/index.php/studentCcompleted">Past Conferences</a> </li>
		</ul>
	</li>
