...
function index ()
{
	...
	$this->load->model('project_model');
					...
					foreach($Query->result() as $row)
					 ...
					 <TR><TD align = left colspan=2><br></TD></TR>
					 <TR><TD align = left colspan=2>The Research Subcommittee of the FPR Committee has approved the following Research Project proposal submitted by Prof........... Please issue a Work Order for the project.</TD></TR>
					 <TR><TD align = left colspan=2><br></TD></TR>
