...
class FacultyProjPending extends CI_Controller {
	...
	function load_php()
				...
				$result1= $this->project_model-> project_extensionrevision_faculty();
				$result2= $this->project_model-> project_completionrevision_faculty();
				// Display the results
				echo'
					...
					<TABLE width="90%" border="1" bordercolor="#993300" align="center" cellpadding="3" cellspacing="1" class="table_border_both_left"><tr  class="heading_table_top"> 
						...
						<table class="table table-bordered">
					<TD><h4>ProjectTitle</h4></TD><TD><h4>ProjectId</h4></TD><TD><h4>Start Date</h4></TD><TD><h4>End Date</h4></TD><TD><h4>Period</h4></TD><TD><h4>Researcher1</h4></TD><TD><h4>Researcher2</TD><TD><h4>Researcher3</h1></TD><TD><h4>Comments</h1></TD><TD><h4>Select</h1></TD>
					
					<tbody>';
					echo 'Extension:Projects Sent Back For Revision';
				...
				<TABLE width="90%" border="1" bordercolor="#993300" align="center" cellpadding="3" cellspacing="1" class="table_border_both_left"><tr  class="heading_table_top"> 
					...
					<tbody>';
					echo '<p></br></p>';
					echo 'Completion:Projects Sent Back For Revision';
