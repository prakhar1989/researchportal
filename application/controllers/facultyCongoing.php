...
class FacultyCOngoing extends CI_Controller {
	...
	function load_php()
				...
				$result= $this->conference_model->ongoingFacultyConferences('anurag');
				...
				// Display the results
				echo'
					<FORM METHOD=POST ACTION="http://localhost/ci/index.php/FacultyConfShowDetails">
